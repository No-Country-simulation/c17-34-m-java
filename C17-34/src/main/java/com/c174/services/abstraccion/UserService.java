...
import com.c174.models.user.AuthDto;
...
public interface UserService {
    ...
    AuthDto subscribeUser(UserRequest user) throws EntityExistsException;
    AuthDto loginUser(String email, String password) throws EntityNotFoundException;
}
