...
const FloatingNavbarMobile = () => {
  ...
  const isP2PActive =
    location.pathname.startsWith("/tickets/purchase") ||
    location.pathname.startsWith("/tickets/sale");
  const isOffersActive =
    location.pathname.startsWith("/offers/active") ||
    location.pathname.startsWith("/offers/completed");
        ...
        <nav className="p2p-navbar">
          <ul>
            <li>
              <NavLink
                to="/tickets/purchase"
                className={isP2PActive ? "active-link" : ""}
              >
                <div className="icon">
            ...
            <li className="mobile-only">
              <NavLink
                to="/offers/active"
                className={isOffersActive ? "active-link" : ""}
              >
                <div className="icon">
